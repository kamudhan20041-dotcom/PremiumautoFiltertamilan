...
# --- SPEED SETTINGS ---
# Cache time: Keeps search results in memory for 5 minutes (300s) to reduce DB load
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

# Max Buttons: Limits search results to 10 per page to prevent lag
...
# OPTIMIZATION: Default to False to save processing time
SPELL_CHECK_REPLY = is_enabled(environ.get("SPELL_CHECK_REPLY", "False"), False)

# OPTIMIZATION: Default to 5 to avoid sending massive messages
